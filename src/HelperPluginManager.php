...
class HelperPluginManager extends AbstractPluginManager
{
    ...
    protected $invokableClasses = array(
        ...
        'htmltag'             => 'Laminas\View\Helper\HtmlTag',
    ...
    public function injectTranslator($helper)
    {
        ...
        if ($locator->has('Laminas\I18n\Translator\TranslatorInterface')) {
            $helper->setTranslator($locator->get('Laminas\I18n\Translator\TranslatorInterface'));
            return;
        }
